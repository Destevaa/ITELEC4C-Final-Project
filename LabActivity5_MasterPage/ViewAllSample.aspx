<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAllSample.aspx.cs" Inherits="LabActivity5_MasterPage.ViewAllSample" %>
...
<body style="height: 479px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 54px; top: 138px; position: absolute" Text="Members:"></asp:Label>
    </form>
</body>
</html>
